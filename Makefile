...
build-paimonganyu:
	cd PaimonGanyu; chmod 777 gradlew; ./gradlew -x test paimonganyu-app:paimonganyu:sB

build-paimonganyu-skill:
	cd PaimonGanyu; chmod 777 gradlew; ./gradlew -x test paimonganyu-app:paimonganyu-skill:sB
