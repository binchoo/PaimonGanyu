 ...
 * @since : 2022-10-22
 */
public interface DailyCheckAsyncApi extends HoyolabApi {
     ...
     */
    Mono<HoyoResponse<DailyCheckResult>> claimDailyCheck(LtuidLtoken ltuidLtoken) throws SignInException;
     ...
     * @return 이번달 일일 체크 현황
     */
    Mono<HoyoResponse<DailyCheckMonthlyReport>> getDailyCheckStatus(LtuidLtoken ltuidLtoken);
}
