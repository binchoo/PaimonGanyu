...
public class AwsEventParserFactory {
    ...
    private final ParsingManual manual;
     ...
     * @throws UnknownError When the type of {@code event} is unknown to {@link ParsingManual}.
    ...
    private static final class DefaultFactoryConfigurer implements AwsEventParserFactoryConfigurer {
        ...
        @Override
        public void configure(ParsingManual manual) {
            manual
