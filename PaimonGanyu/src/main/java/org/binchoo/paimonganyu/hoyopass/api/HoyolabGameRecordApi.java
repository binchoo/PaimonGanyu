package org.binchoo.paimonganyu.hoyopass.api;
...
public interface HoyolabGameRecordApi extends HoyolabApi {
     ...
     */
    List<GenshinAvatar> getAllCharacter(LtuidLtoken ltuidLtoken, String uid, String server);
     ...
     */
    List<GenshinAvatar> getCharacters(LtuidLtoken ltuidLtoken, String uid, String server, long... characterId);
     ...
     */
    DailyNote getDailyNote(LtuidLtoken ltuidLtoken, String uid, String server);
}
