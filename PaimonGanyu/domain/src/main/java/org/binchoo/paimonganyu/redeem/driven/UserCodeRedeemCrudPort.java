...
public interface UserCodeRedeemCrudPort {
     ...
     */
    boolean existsRedeemHistory(UserCodeRedeem userCodeRedeem);
    ...
    /**
     * 모든 {@link UserCodeRedeem}를 조회합니다.
     * @return 모든 {@link UserCodeRedeem}의 리스트.
     */
    List<UserCodeRedeem> findAll();

    /**
     * {@link UserCodeRedeem}를 저장합니다.
     */
    void save(UserCodeRedeem userCodeRedeem);
}
