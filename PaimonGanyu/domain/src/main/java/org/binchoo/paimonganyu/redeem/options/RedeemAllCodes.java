 ...
 * @since : 2022/04/17
 */
public class RedeemAllCodes implements EstimationOption {
     ...
     */
    public RedeemAllCodes(RedeemCodeCrudPort redeemCodeCrudPort, List<UserHoyopass> givenUserHoyopasses) {
