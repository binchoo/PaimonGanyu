package org.binchoo.paimonganyu.integration.hoyopass.ssm;

import com.amazonaws.services.simplesystemsmanagement.AWSSimpleSystemsManagement;
import org.binchoo.paimonganyu.hoyopass.driven.SigningKeyManagePort;
import org.binchoo.paimonganyu.infra.hoyopass.ssm.SsmSigningKeyManage;
...
class SsmSigningKeyManagerIntegTest {
    ...
    @Lazy
    @Bean
    SigningKeyManagePort ssmSigningKeyManager(
        ...
        return new SsmSigningKeyManage(publicKeyName, privateKeyName, ssmClient);
    }
